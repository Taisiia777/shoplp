    ...
    return (
        <div className="flex justify-center self-stretch">
            <div className="container-xs flex justify-center md:px-[1.25rem]">
                <div className="h-[21.88rem] w-full rounded-[20px] bg-[url(/public/images/img_refund.png)] bg-cover bg-no-repeat px-[1.25rem] py-[2.13rem] md:h-auto sm:py-[1.25rem]">
                    <div className="mb-[8.88rem] flex flex-col items-start gap-[0.88rem]">
                        ...
                        <Text
                            size="textlg"
                            as="p"
                            className="w-[40%] text-[1.38rem] font-normal leading-[1.88rem] text-black md:w-full"
                        >
                            <>
